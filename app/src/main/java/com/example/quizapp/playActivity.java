...
public class playActivity extends AppCompatActivity {
    String[] question_list = {"What number is inseparable from the footballer Cristiano Ronaldo ?",
            "Where is Portuguese footballer Cristiano Ronaldo from?","which country has Cristiano Ronaldo never been a member of a club?"
            ,"Which football club did Cristiano Ronaldo stay with the longest continuously?",
           "How many Champions Leagues did Cristiano Ronaldo win during his Madrid career from 2009 to 2018?"
    };
    String[] choose_list = {"3","7","14","19",
            "porto","lisbon","madeira","faro",
            "italy","germany","spain","england",
            "juventus","united","barcelone","madrid",
            "1","2","4","5"
    };
    String[] correct_list = {"7","madeira","germany","madrid","4"};
